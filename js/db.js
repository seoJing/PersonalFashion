...
const resultArr = [
  {
    ...
    img: ['https://i.imgur.com/iSar8ZU.png', 'https://i.imgur.com/9GcMIOv.png', 'https://i.imgur.com/wDFS8i7.png'],
    youtube: {
      name: '패션튜브삭형',
  ...
  },
  {
    ...
    img: ['https://i.imgur.com/Ta08GPu.png', 'https://i.imgur.com/TPIPvRD.png', 'https://i.imgur.com/qZZCh1L.png'],
    youtube: {
      name: '피로',
  ...
  },
  {
    ...
    img: ['https://i.imgur.com/J0rEcAX.png', 'https://i.imgur.com/sAQEjni.png', 'https://i.imgur.com/tSMt2Am.png'],
    youtube: {
      name: '우연',
  ...
  },
  {
    ...
    img: ['https://i.imgur.com/dPHtHtU.png', 'https://i.imgur.com/YcFdqtK.png', 'https://i.imgur.com/VjmZAYs.png'],
    youtube: {
      name: '코스모쓰 패션한짠',
